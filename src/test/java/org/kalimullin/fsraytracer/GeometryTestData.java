...
public class GeometryTestData {
    ...
    public static final Face FACE_ONE = new Face(Arrays.asList(POINT_ZERO, POINT_ONE, POINT_TWO));
    public static final Face FACE_TWO = new Face(Arrays.asList(POINT_ONE, POINT_TWO, POINT_THREE));
    ...
    private static List<Polygon> polygonSet = new ArrayList<>();
